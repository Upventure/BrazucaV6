...
<div class="section-1 image-bites-1">
    <div class="mask-layer mask-layer-2 mask-layer-fruit-page">
        <div class="content-hoofd-foto">
            ...
            <h1 style="font-size:40px;">Brazuca Bites </h1>
...
<div class="wrapper-section-bottom" style="background-color: #E6DECA;">
    <div class="advertisements">
        <div class='referal-advertisement image-bites-3'>
            <div class='content mask-layer' style="background-color:rgba(152, 139, 24, 0.27);">
                <!-- <div class=''><h1><br></h1></div> -->
                <div style='width: 100%; background-color:#E6DECA; height:35px;'></div>
                <div class='summary summary-extra' style="border: solid  2px whitesmoke">
                    <h1 style="color: white;">Oorsprong Pão de queijo</h1>
                    <p style="color: white;">
