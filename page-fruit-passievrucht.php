...
<div class="section-1 image-Passievrucht-1 ">
    <div class="mask-layer mask-layer-2 mask-layer-fruit-page">
      ...
      <!-- <h1 style="font-size:30px; margin-top:20px; padding:0px;">Brazuca Coffee </h1> -->
        ...
        <h1 style='font-size:30px;'>  Passievruchten sap  </h1>

    <p style="font-size:20px; margin-top: 5px;" class="ondertitel">Heerlijke verse Passievruchten sap <br>rechtstreeks uit de Amazone</p>
    </div>
    </div>
</div>
